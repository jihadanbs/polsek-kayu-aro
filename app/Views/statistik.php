...
<body class="blog-details-page">
    ...
    <script>
        ...
        const chart = Highcharts.chart('container', {
            ...
            tooltip: {
                formatter: function() {
                    // Tampilkan nama kategori + jumlah + satuan
                    return `<b>${this.x}</b>: ${this.y} ${this.series.userOptions.tooltipSuffix || ''}`;
                },
                crosshairs: true,
                shared: true
            },
        ...
        function updateChart() {
            ...
            // Tentukan teks tooltip berdasarkan kategori
            let tooltipSuffix = '';
                        ...
                        chart.update({
                            ...
                            series: [{
                                ...
                                data: values.map((value, index) => ({
                                    y: value,
                                    color: colors[index % colors.length] // Use color from the array
                                })),
