                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <form action="<?= base_url('authentication/cekRegistrasi') ?>" method="post" class="mt-4 pt-2" autocomplete="off">
                                        ...
                                        <div class="mb-3">
                                            <button class="btn w-100 waves-effect waves-light" type="submit" style="background-color: #dc3545; color: #fff;">Registrasi</button>
                                        </div>
                                    </form>

                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0">Sudah Punya Akun ? <a href="<?= site_url('/authentication/login'); ?>" class="text-danger fw-semibold"> Login</a> </p>
                                    </div>
                                </div>
