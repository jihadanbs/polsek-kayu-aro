                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    <p><?= esc($tb_foto['tanggal_foto'] ?? '', 'html'); ?></p>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-body">
                                                                <div id="carouselExampleControls<?= esc($tb_foto['id_foto'] ?? '', 'attr'); ?>" class="carousel slide" data-bs-ride="carousel">
                                                                    <div class="carousel-inner">
                                                                        <?php foreach (explode(', ', $tb_foto['file_foto']) as $index => $file) : ?>
                                                                            <div class="carousel-item <?= $index === 0 ? 'active' : '' ?>">
                                                                    ...
                                                                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleControls<?= esc($tb_foto['id_foto'] ?? '', 'attr'); ?>" data-bs-slide="prev" style="background-color: black; border-radius: 10px;">
                                                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                                                        <span class="visually-hidden">Previous</span>
                                                                    </button>
                                                                    <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls<?= esc($tb_foto['id_foto'] ?? '', 'attr'); ?>" data-bs-slide="next" style="background-color: black; border-radius: 10px;">
                                                                        <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                                                        <span class="visually-hidden">Next</span>
                                                                    </button>
                                                                </div>
        ...
        $('.sa-warning').click(function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "/admin/galeri/delete2", // Ubah sesuai dengan URL
                        data: {
                            id_foto: id_foto,
                            _method: 'DELETE'
                        },
