                ...
                <div class="col-10">
                    <div class="card border border-secondary rounded p-4">
                        <div class="card-body">
                            ...
                            <form action="<?= esc(site_url('admin/desa/update/' . $tb_desa['id_desa']), 'attr') ?>" method="post" enctype="multipart/form-data" id="validationForm" novalidate autocomplete="off" onsubmit="cleanInput()">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="number" class="form-control <?= ($validation->hasError('kode_pos')) ? 'is-invalid' : ''; ?>" id="kode_pos" style="background-color: white;" name="kode_pos" placeholder="Masukkan Kode Pos Desa Ini" value="<?= esc(old('kode_pos', $tb_desa['kode_pos']), 'html'); ?>">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="text" oninput="formatNumber(this)" class="form-control <?= ($validation->hasError('luas_wilayah')) ? 'is-invalid' : ''; ?>" id="luas_wilayah" style="background-color: white;" name="luas_wilayah" placeholder="Masukkan Luas Wilayah Desa Ini" value="<?= esc(old('luas_wilayah', $tb_desa['luas_wilayah']), 'html'); ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="text" oninput="formatNumber(this)" class="form-control <?= ($validation->hasError('jumlah_penduduk')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk" style="background-color: white;" name="jumlah_penduduk" placeholder="Masukkan Jumlah Penduduk Desa Ini" value="<?= esc(old('jumlah_penduduk', $tb_desa['jumlah_penduduk']), 'html'); ?>">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="text" oninput="formatNumber(this)" class="form-control <?= ($validation->hasError('jumlah_kepala_keluarga')) ? 'is-invalid' : ''; ?>" id="jumlah_kepala_keluarga" style="background-color: white;" name="jumlah_kepala_keluarga" placeholder="Jumlah Kepala Keluarga" value="<?= esc(old('jumlah_kepala_keluarga', $tb_desa['jumlah_kepala_keluarga']), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="text" oninput="formatNumber(this)" class="form-control <?= ($validation->hasError('jumlah_penduduk_pria')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_pria" style="background-color: white;" name="jumlah_penduduk_pria" placeholder="Jumlah Penduduk Pria" value="<?= esc(old('jumlah_penduduk_pria', $tb_desa['jumlah_penduduk_pria']), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="text" oninput="formatNumber(this)" class="form-control <?= ($validation->hasError('jumlah_penduduk_wanita')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_wanita" style="background-color: white;" name="jumlah_penduduk_wanita" placeholder="Jumlah Penduduk Wanita" value="<?= esc(old('jumlah_penduduk_wanita', $tb_desa['jumlah_penduduk_wanita']), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="text" oninput="formatNumber(this)" class="form-control <?= ($validation->hasError('jumlah_penduduk_sd')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_sd" style="background-color: white;" name="jumlah_penduduk_sd" placeholder="Jumlah Penduduk Menempuh Sekolah Dasar" value="<?= esc(old('jumlah_penduduk_sd', $tb_desa['jumlah_penduduk_sd']), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="text" oninput="formatNumber(this)" class="form-control <?= ($validation->hasError('jumlah_penduduk_smp')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_smp" style="background-color: white;" name="jumlah_penduduk_smp" placeholder="Jumlah Penduduk Menempuh SMP" value="<?= esc(old('jumlah_penduduk_smp', $tb_desa['jumlah_penduduk_smp']), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="text" oninput="formatNumber(this)" class="form-control <?= ($validation->hasError('jumlah_penduduk_sma_smk')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_sma_smk" style="background-color: white;" name="jumlah_penduduk_sma_smk" placeholder="Jumlah Penduduk Menempuh SMA / SMK" value="<?= esc(old('jumlah_penduduk_sma_smk', $tb_desa['jumlah_penduduk_sma_smk']), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="text" oninput="formatNumber(this)" class="form-control <?= ($validation->hasError('jumlah_penduduk_bekerja')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_bekerja" style="background-color: white;" name="jumlah_penduduk_bekerja" placeholder="Jumlah Penduduk Tidak Menganggur" value="<?= esc(old('jumlah_penduduk_bekerja', $tb_desa['jumlah_penduduk_bekerja']), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="text" oninput="formatNumber(this)" class="form-control <?= ($validation->hasError('jumlah_sekolah')) ? 'is-invalid' : ''; ?>" id="jumlah_sekolah" style="background-color: white;" name="jumlah_sekolah" placeholder="Jumlah Sekolah" value="<?= esc(old('jumlah_sekolah', $tb_desa['jumlah_sekolah']), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="text" oninput="formatNumber(this)" class="form-control <?= ($validation->hasError('jumlah_tempat_ibadah')) ? 'is-invalid' : ''; ?>" id="jumlah_tempat_ibadah" style="background-color: white;" name="jumlah_tempat_ibadah" placeholder="Jumlah Tempat Ibadah" value="<?= esc(old('jumlah_tempat_ibadah', $tb_desa['jumlah_tempat_ibadah']), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="text" oninput="formatNumber(this)" class="form-control <?= ($validation->hasError('jumlah_posyandu')) ? 'is-invalid' : ''; ?>" id="jumlah_posyandu" style="background-color: white;" name="jumlah_posyandu" placeholder="Jumlah Posyandu" value="<?= esc(old('jumlah_posyandu', $tb_desa['jumlah_posyandu']), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="text" oninput="formatNumber(this)" class="form-control <?= ($validation->hasError('jumlah_pos_ronda')) ? 'is-invalid' : ''; ?>" id="jumlah_pos_ronda" style="background-color: white;" name="jumlah_pos_ronda" placeholder="Jumlah Pos Ronda" value="<?= esc(old('jumlah_pos_ronda', $tb_desa['jumlah_pos_ronda']), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
