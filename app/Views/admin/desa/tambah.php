                            ...
                            <form action="<?= esc(site_url('admin/desa/save'), 'attr') ?>" method="post" enctype="multipart/form-data" novalidate autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control <?= ($validation->hasError('kode_pos')) ? 'is-invalid' : ''; ?>" id="kode_pos" name="kode_pos" placeholder="Kode Pos" style="background-color: white;" value="<?= esc(old('kode_pos'), 'html'); ?>">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="text" class="form-control <?= ($validation->hasError('luas_wilayah')) ? 'is-invalid' : ''; ?>" id="luas_wilayah" name="luas_wilayah" placeholder="Luas Wilayah" style="background-color: white;" value="<?= esc(old('luas_wilayah'), 'html'); ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_penduduk')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk" name="jumlah_penduduk" placeholder="Jumlah Penduduk" style="background-color: white;" value="<?= esc(old('jumlah_penduduk'), 'html'); ?>">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_kepala_keluarga')) ? 'is-invalid' : ''; ?>" id="jumlah_kepala_keluarga" name="jumlah_kepala_keluarga" placeholder="Jumlah Kepala Keluarga" style="background-color: white;" value="<?= esc(old('jumlah_kepala_keluarga'), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_penduduk_pria')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_pria" name="jumlah_penduduk_pria" placeholder="Jumlah Penduduk Pria" style="background-color: white;" value="<?= esc(old('jumlah_penduduk_pria'), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_penduduk_wanita')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_wanita" name="jumlah_penduduk_wanita" placeholder="Jumlah Penduduk Wanita" style="background-color: white;" value="<?= esc(old('jumlah_penduduk_wanita'), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_penduduk_usia_0_14')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_usia_0_14" name="jumlah_penduduk_usia_0_14" placeholder="Jumlah Penduduk Usia 0 - 14th" style="background-color: white;" value="<?= esc(old('jumlah_penduduk_usia_0_14'), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_penduduk_usia_15_64')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_usia_15_64" name="jumlah_penduduk_usia_15_64" placeholder="Jumlah Penduduk Usia 15 - 64th" style="background-color: white;" value="<?= esc(old('jumlah_penduduk_usia_15_64'), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="col-sm-12 input-group">
                                        <input type="number" class="form-control <?= ($validation->hasError('jumlah_penduduk_usia_65_keatas')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_usia_65_keatas" name="jumlah_penduduk_usia_65_keatas" placeholder="Jumlah Penduduk Usia 65th ke Atas" style="background-color: white;" value="<?= esc(old('jumlah_penduduk_usia_65_keatas'), 'html'); ?>">
                                        <span class="input-group-text">Jiwa</span>
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_penduduk_tidak_sekolah')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_tidak_sekolah" name="jumlah_penduduk_tidak_sekolah" placeholder="Jumlah Penduduk Tidak Sekolah" style="background-color: white;" value="<?= esc(old('jumlah_penduduk_tidak_sekolah'), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_penduduk_sd')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_sd" name="jumlah_penduduk_sd" placeholder="Jumlah Penduduk Menempuh Sekolah Dasar" style="background-color: white;" value="<?= esc(old('jumlah_penduduk_sd'), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_penduduk_smp')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_smp" name="jumlah_penduduk_smp" placeholder="Jumlah Penduduk Menempuh SMP" style="background-color: white;" value="<?= esc(old('jumlah_penduduk_smp'), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_penduduk_sma_smk')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_sma_smk" name="jumlah_penduduk_sma_smk" placeholder="Jumlah Penduduk Menempuh SMA / SMK" style="background-color: white;" value="<?= esc(old('jumlah_penduduk_sma_smk'), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_penduduk_bekerja')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_bekerja" name="jumlah_penduduk_bekerja" placeholder="Jumlah Penduduk Tidak Menganggur" style="background-color: white;" value="<?= esc(old('jumlah_penduduk_bekerja'), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_penduduk_tidak_bekerja')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_tidak_bekerja" name="jumlah_penduduk_tidak_bekerja" placeholder="Jumlah Penduduk Menganggur" style="background-color: white;" value="<?= esc(old('jumlah_penduduk_tidak_bekerja'), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_penduduk_menikah')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_menikah" name="jumlah_penduduk_menikah" placeholder="Jumlah Penduduk Sudah Menikah" style="background-color: white;" value="<?= esc(old('jumlah_penduduk_menikah'), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_penduduk_belum_menikah')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_belum_menikah" name="jumlah_penduduk_belum_menikah" placeholder="Jumlah Penduduk Masih Lajang" style="background-color: white;" value="<?= esc(old('jumlah_penduduk_belum_menikah'), 'html'); ?>">
                                            <span class="input-group-text">Jiwa</span>
                                            <div class="invalid-feedback">
                                ...
                                <div class="col-mb-3">
                                    ...
                                    <div class="col-sm-12 input-group">
                                        <input type="number" class="form-control <?= ($validation->hasError('jumlah_penduduk_cerai')) ? 'is-invalid' : ''; ?>" id="jumlah_penduduk_cerai" name="jumlah_penduduk_cerai" placeholder="Jumlah Penduduk Cerai" style="background-color: white;" value="<?= esc(old('jumlah_penduduk_cerai'), 'html'); ?>">
                                        <span class="input-group-text">Jiwa</span>
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_sekolah')) ? 'is-invalid' : ''; ?>" id="jumlah_sekolah" name="jumlah_sekolah" placeholder="Jumlah Sekolah" style="background-color: white;" value="<?= esc(old('jumlah_sekolah'), 'html'); ?>">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_tempat_ibadah')) ? 'is-invalid' : ''; ?>" id="jumlah_tempat_ibadah" name="jumlah_tempat_ibadah" placeholder="Jumlah Tempat Ibadah" style="background-color: white;" value="<?= esc(old('jumlah_tempat_ibadah'), 'html'); ?>">
                                            <span class="input-group-text">Unit</span>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_posyandu')) ? 'is-invalid' : ''; ?>" id="jumlah_posyandu" name="jumlah_posyandu" placeholder="Jumlah Posyandu" style="background-color: white;" value="<?= esc(old('jumlah_posyandu'), 'html'); ?>">
                                            <span class="input-group-text">Unit</span>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-sm-12 input-group">
                                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_pos_ronda')) ? 'is-invalid' : ''; ?>" id="jumlah_pos_ronda" name="jumlah_pos_ronda" placeholder="Jumlah Pos Ronda" style="background-color: white;" value="<?= esc(old('jumlah_pos_ronda'), 'html'); ?>">
                                            <span class="input-group-text">Unit</span>
                                            <div class="invalid-feedback">
